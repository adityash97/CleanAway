...
#-----------------------------------------------
//
$dee="SELECT `volunteerRegion` FROM `volunteer` where volunteerEmail='$u_email' ";   
$rmm=mysqli_query($conn,$dee);
$rrr=mysqli_fetch_array($rmm);
$region_adress=$rrr['volunteerRegion'];



/*//Finding Employee based on the location
$sde1="SELECT * FROM `compliant`,locality WHERE ngoID IS NULL AND compliant.Location1=locality.LID ";
$resulte1=mysqli_query($conn,$sde1);
*/

//Finding Employee based on the location
/*$sql = "SELECT * FROM compliant WHERE ngoID IS NULL";
...
{*/
//Finding Employee based on the location
$sde="SELECT * FROM `compliant`,locality WHERE volunteerID IS NULL  AND compliant.Location1=locality.LID AND ngoID is NULL AND Location1='$region_adress'";
...
echo '<img src="img/accept.jpg" alt="accept"  border="0">
 ...
 echo '<a href="delete.php?a='.$rrr['ID'].'"> ';
echo '<img src="img/delete.jpg"  alt="delete"  border="0">
</a>' ;
echo  '<td>';  echo'<img src="../User/img/' ; echo $rrr['Image'];echo'"width:"302" height:"168"'; echo'" figure class="movie-poster">';echo '</td>';
}
echo '</tr>';

/*else {
    echo "<script language=\"JavaScript\">\n";
    echo "alert('No Pending Request !');\n";
...
<tr>
                ...
                <td><?php //echo $row['volunteerRegion']; ?></td>
