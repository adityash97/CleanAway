...
#------------------------------------------------------------------------------------------------------------------------------
$sqll="select * from location where email='$data[0]'";
...
<html>
  <head>
    ...
    <meta charset="utf-8">
    <title>Hunger - Location<code>setPanel()</code></title>
<link rel="shortcut icon" href="../Img/letter-h.png">
  ...
  <body>
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyD3ej0wvg0oWKysTdzYd7wz778GY_gj2_Y>
    </script>
  </body>
</html>