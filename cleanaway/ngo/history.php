...
#-----------------------------------------------
//
$dee="SELECT `ngoID` FROM `ngo` where ngoEmail='$u_email'";	
$rmm=mysqli_query($conn,$dee);
$rrr=mysqli_fetch_array($rmm);
$employee_id=$rrr['ngoID'];
//Finding Employee based on the location



$sde="SELECT * FROM `Compliant`,locality where  ngoID ='$employee_id' AND compliant.Location1=locality.LID";
