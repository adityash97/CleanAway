...
$sql = "SELECT * FROM user,locality WHERE UserEmail='$u_email' AND user.userRegion=locality.LID";
...
if($rec>0)
  ...
  <form action="userconfirm.php" method="post" >
    ...
    <div class="inner-wrap">
        <label>Name <input type="text" name="name" value="<?php echo $rec['userName']; ?>"  required data-validation-required-message="Please enter your place." /></label><br>
    ...
    <div class="inner-wrap">
        <label>Email Address <br><input type="email" name="email" value="<?php echo $rec['userEmail']; ?>"  required data-validation-required-message="Please enter your Email Address." /></label><br>
        <label>Phone Number <input type="text" name="phone" value="<?php echo $rec['userMobile']; ?>" pattern="[789][0-9]{9}" required data-validation-required-message="Please enter your Phone Number."/></label>
    </div>
