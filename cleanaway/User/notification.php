...
<!--Include Header-->
	...
	<?php
	#------------------------------------------------------------------------------------------------------------------------------
	$zx="SELECT * FROM `Compliant`,locality where User_Email='$u_email' and VolunteerID IS NULL and ngoID is null AND compliant.Location1=locality.LID";
...
?>
 ...
 <?php
  ...
  echo '<tr>';
	...
	if($re['volunteerID']==NULL)
	{
		$re['volunteerID']="On Progresss";
	}
	echo '<td>';echo $re['volunteerID']; echo '</td>';
/* #------------------------------------------------------------------------------------------------------------------------------
