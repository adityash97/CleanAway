...
.form-style-10 .privacy-policy{
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                              <thead>
                                <tr>
                                  <th><form action="" method="post"><input type="text" id="myInput" name="name"  placeholder="Search for names..">
 ...
 $sql = "SELECT * FROM volunteer,locality WHERE volunteerName='$volunteerName' AND volunteer.volunteerRegion=locality.LID";
...
<form action="<?php echo "delete_ngo.php/id=". $rec['volunteerID']; ?>" method="POST">
   <div class="section"><span>1</span>Volunteer ID </div>
    <div class="inner-wrap">
        <label>Volunteer ID <input type="text" name="id" value="<?php echo $rec['volunteerID']; ?>" disabled /> </label>
          </div>
    <div class="section"><span>2</span>Place &amp; Address</div>
    <div class="inner-wrap">
        <label>Name <input type="text" name="name" value="<?php echo $rec['volunteerName']; ?>" disabled required data-validation-required-message="Please enter your place." /></label>
        <label>Address <input type="text" name="address" value="<?php echo $rec['locality1']; ?>" disabled required data-validation-required-message="Please enter your Address."  ></textarea></label>
    </div>

    <div class="section"><span>3</span>Email &amp; Phone</div>
    <div class="inner-wrap">
        <label>Email Address <input type="email" name="email" value="<?php echo $rec['volunteerEmail']; ?>" disabled required data-validation-required-message="Please enter your Email Address." /></label>
        <label>Phone Number <input type="text" name="phone" value="<?php echo $rec['volunteerMobile']; ?>" disabled pattern="[789][0-9]{9}" required data-validation-required-message="Please enter your Phone Number."/></label>
    </div>

    <div class="section"><span>4</span>Date Estd.</div>
        <div class="inner-wrap">
        <label>Date <input type="date" id="dt" value="<?php echo $rec['volunteerDate']; ?>" name="date_" disabled required data-validation-required-message="Please enter your Password" /></label>

        
    </div>
    <div class="button-section">
    <!-- <input type="submit" name="delete" value="Delete" />-->
     <a href="<?php echo 'delete.php?vol='.$rec['volunteerID']; ?>" >DELETE</a>
