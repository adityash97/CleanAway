...
.form-style-10 .privacy-policy{
  ...
  <section id="container" class="">
                                ...
                                <tr >
                                  <th><form action="" method="post">
                                   <!--  <input type="text" id="myInput" name="locality1"  placeholder="Search by location..">
                                    ...
                                    <label>Address</label><input type="text" name="area" required="required"><br>
                                <!-- <Label>you can search</Label>

										<input type="radio" name="search_type" value="ngo">NGO
										<input type="radio" name="search_type" value="vol">Volunteer<br>  -->
    ...
    $area = $_POST['area'];
         ...
         $sql = "SELECT * FROM compliant,locality WHERE  locality1='$area'   AND compliant.Location1=locality.LID AND ((VolunteerID IS NOT NULL) or (ngoID is not NuLL)) AND Date BETWEEN str_to_date(' $Stardate_', '%Y-%m-%d') AND '$Enddate_'";
  ...
  $cngo=$recc['nid'];*/
          ...
          ?>
                          ...
                          <table class="table table-striped table-advance table-hover">
                           <tbody>
                            <caption>Area : <input type="text" name="" value="<?php echo $area; ?>"> Report From : <input type="text" name="" value="<?php echo $Stardate_; ?>" readonly> To : <input type="text" name="" value="<?php echo $Enddate_; ?>" readonly>Status : <input type="text" name="" value="Completed" readonly=""> </caption>
                    <!--            <tr >
                      ...
                      <tr >
                        <th style="text-align: center; border: 1px solid #ddd;" >Address</th> 
                        <!--  <th style="text-align: center; border: 1px solid #ddd;" >No. of User</th> 
                         -->   <th style="text-align: center; border: 1px solid #ddd;">Compliant Type</th>  
                         <th style="text-align: center; border: 1px solid #ddd;">Description</th>  
                           <!--   <th style="text-align: center; border: 1px solid #ddd;" >Completed On</th> 
                              
                            <th style="text-align: center; border: 1px solid #ddd;">Completed By</th>
                            --> 
        ...
        ?>
              <tr >
                <td style="text-align: center; border: 1px solid #ddd;"><?php echo $row['Location2']; ?></td>
                <td style="text-align: center; border: 1px solid #ddd;"><?php echo $row['Compliant_Type']; ?></td>
                <td style="text-align: center; border: 1px solid #ddd;"><?php echo $row['Description']; ?></td>
                ...
                {
                  echo "NO DATA AVAILABLE IN THE DATABASE BETWEEN '$Stardate_' TO '$Enddate_'";
                }
              }
                  ?>
