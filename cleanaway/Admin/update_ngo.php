...
.form-style-10 .privacy-policy{
  ...
  <section id="container" class="">
     ...
     <?php include ("sidebar.php"); ?>
      ...
      <div class="rec">
        <div class="col-lg-12">
          <h3 class="page-header"><i class="fa fa-table"></i>Search NGO</h3>
          <ol class="breadcrumb">
            <li><i class="fa fa-home"></i><a href="index.php">Home</a></li>
            <li><i class="fa fa-th-list"></i><a href="ngo_list.php">NGO List</a></li>
            <li><i class="fa fa-search"></i>Search NGO</li>
          </ol>
        </div>
      </div>
              <!-- page start -->
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                              <thead>
                                <tr>
                                  <th><form action="update_ngo.php" method="post"><input type="text" id="myInput" name="id"  placeholder="Search by ID..">
 ...
 $sql = "SELECT * FROM ngo,locality WHERE ngoID='$ngoName' AND ngo.ngoRegion=locality.LID";
...
<?php
 ...
 /*$sql = "SELECT * FROM customerinfo,locality WHERE username='$usr' AND customerinfo.locality=locality.loid";
 */
...
<h1>Update NGO!</h1>
<form action="updatengophp.php" method="post">
   <div class="section"><span>1</span>NGO ID &amp; Registration ID</div>
    <div class="inner-wrap">
        <label>NGO ID <input type="text" name="id" value="<?php echo $rec['ngoID']; ?>" readonly /> </label>
          <label>Registration ID <input type="text" name="registration" value="<?php echo $rec['ngoregID']; ?>"   required data-validation-required-message="Please enter your place." /></label>
        
          </div>
    <div class="section"><span>2</span>Place &amp; Address</div>
    <div class="inner-wrap">
        <label>Name <input type="text" name="name" value="<?php echo $rec['ngoName']; ?>"  required data-validation-required-message="Please enter your place." /></label>
    ...
    <div class="inner-wrap">
        <label>Email Address <input type="email" name="email" value="<?php echo $rec['ngoEmail']; ?>"  required data-validation-required-message="Please enter your Email Address." /></label>
        <label>Phone Number <input type="text" name="phone" value="<?php echo $rec['ngoMobile']; ?>" pattern="[789][0-9]{9}" required data-validation-required-message="Please enter your Phone Number."/></label>
    </div>

    <div class="section"><span>4</span>Date Estd.</div>
        <div class="inner-wrap">
        <label>Date <input type="date" id="dt" value="<?php echo $rec['ngoDate']; ?>" name="date_" required data-validation-required-message="Please enter your Password" /></label>
...
<?php
  ...
  echo '<script>alert("'.$ngoName.' NOT FOUND IN THE DATABASE.");window.location="ngo_list.php"</script>';
}
}
                        ?>  
</div>  
