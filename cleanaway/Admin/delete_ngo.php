...
.form-style-10 .privacy-policy{
                  ...
                  <div class="col-lg-12">
                      ...
                      <div class="table-responsive">
                        <table class="table">
                              <thead>
                                <tr>
                                  <th><form action="delete_ngo.php" method="post"><input type="text" id="myInput" name="name"  placeholder="Search for names..">
 ...
 $sql = "SELECT * FROM ngo,locality WHERE ngoName='$ngoName' AND ngo.ngoRegion=locality.LID";
...
<h1>Delete NGO!</h1>
<form action="<?php echo "delete_ngo.php/id=". $rec['ngoID']; ?>" method="POST">
   <div class="section"><span>1</span>NGO ID &amp; Reg. ID</div>
    <div class="inner-wrap">
        <label>NGO ID <input type="text" name="id" value="<?php echo $rec['ngoID']; ?>" readonly /> </label>
        <label>NGO Reg. ID <input type="text" name="id" value="<?php echo $rec['ngoregID']; ?>" readonly /> </label>
          </div>
    <div class="section"><span>2</span>Place &amp; Address</div>
    <div class="inner-wrap">
        <label>Name <input type="text" name="name" value="<?php echo $rec['ngoName']; ?>" readonly required data-validation-required-message="Please enter your place." /></label>
    ...
    <div class="inner-wrap">
        <label>Email Address <input type="email" name="email" value="<?php echo $rec['ngoEmail']; ?>" readonly required data-validation-required-message="Please enter your Email Address." /></label>
        <label>Phone Number <input type="text" name="phone" value="<?php echo $rec['ngoMobile']; ?>" readonly pattern="[789][0-9]{9}" required data-validation-required-message="Please enter your Phone Number."/></label>
    </div>

    <div class="section"><span>4</span>Date Estd.</div>
        <div class="inner-wrap">
        <label>Date <input type="date" id="dt" value="<?php echo $rec['ngoDate']; ?>" name="date_" readonly required data-validation-required-message="Please enter your Password" /></label>

        
    </div>
    <div class="button-section">
    <!-- <input type="submit" name="delete" value="Delete" />-->
     <a href="<?php echo 'delete.php?ngo='.$rec['ngoID']; ?>">DELETE</a>
